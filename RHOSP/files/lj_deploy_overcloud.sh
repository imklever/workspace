...
sudo ./tools/process-templates.py -r /home/stack/lj_templates/roles_data.yaml -n /home/stack/lj_templates/network_data.yaml

cd /home/stack
openstack overcloud deploy --answers-file ~/lj_templates/answers.yaml \
