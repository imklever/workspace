#!/bin/bash
    ...
    echo "test on sda time start:" > ./log/sda/time.log
    ...
    echo "test on sdb time start:" > ./log/sdb/time.log
    ...
    echo "test on sdd time start:" > ./log/sdd/time.log
    ...
    echo "test on sde time start:" > ./log/sde/time.log
    ...
    echo "test on sdf time start:" > ./log/sdf/time.log
    ...
    echo "test on sdg time start:" > ./log/sdg/time.log
    ...
    echo "test on sdh time start:" > ./log/sdh/time.log
    ...
    echo "test on sdi time start:" > ./log/sdi/time.log
    ...
    echo "test on sdj time start:" > ./log/sdj/time.log
    ...
    echo "test on sdk time start:" > ./log/sdk/time.log
    ...
    echo "test on sdl time start:" > ./log/sdl/time.log
    ...
    echo "test on sdm time start:" > ./log/sdm/time.log
    ...
    echo "test on sdn time start:" > ./log/sdn/time.log
