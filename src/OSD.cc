  ...
  ThreadPool::TPHandle &handle)
{
  ...
  t.set_role(pg->is_primary() || pg->is_up_primary());
                                       ...
                                       ThreadPool::TPHandle *handle)
{
  if (!ctx.transaction->empty()) {
	...
	ctx.transaction->set_role(pg->is_primary() || pg->is_up_primary());
...
void OSD::_remove_pg(PG *pg)
{
  ...
  rmt.set_role(pg->is_primary() || pg->is_up_primary());
  int tr = store->queue_transaction(
